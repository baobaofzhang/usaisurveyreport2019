...
```{r demographicsupportstackbar, echo=FALSE, fig.height=10, fig.keep='all', cache=TRUE, warning=FALSE, dpi = 300, dev = 'pdf', fig.width=8.5, fig.cap="Support for developing AI across demographic characteristics"}
...
```{r demographicsupportregression, echo=FALSE, fig.height=10, fig.keep='all', cache=TRUE, warning=FALSE, dpi = 300, dev = 'pdf', fig.width=7, fig.cap="Predicting support for developing AI using demographic characteristics: average support across groups"}
...
```{r demosupporthlmi1, echo=FALSE, fig.height=10, fig.keep='all',  warning=FALSE, cache=TRUE, dpi = 300, fig.width=8, dev = 'pdf', fig.cap="Predicting support for developing high-level machine intelligence using demographic characteristics: distribution of responses"}
...
```{r demosupporthlmi1b, echo=FALSE, fig.height=9.5, fig.keep='all',  warning=FALSE, cache=TRUE, dpi = 300, fig.width=7, dev = 'pdf', fig.cap="Predicting support for developing high-level machine intelligence using demographic characteristics: average support across groups"}
...
```{r uschinaapp3, echo=FALSE, fig.height=7, fig.keep='all', fig.width=7, cache=TRUE, warning=FALSE, dpi = 300, dev = 'pdf'}
...
```{r armsracecorrmain, echo=FALSE, fig.height=7, fig.keep='all', fig.width=7, warning=FALSE, cache=TRUE, dpi = 300, dev = 'pdf'}
kable(
...
```{r armsracecorr, echo=FALSE, fig.height=5, fig.keep='all', fig.width=7, fig.cap = "Correlation between responses to the two statements from survey experiment", warning=FALSE, cache=TRUE, dpi = 300, dev = 'pdf'}
...
```{r attritiontimeline3, echo=FALSE, fig.height=7, fig.keep='all', fig.width=7, warning=FALSE, cache=TRUE, dpi = 300, dev = 'pdf'}
